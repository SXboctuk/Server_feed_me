...
const getAll = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const cookbooks = yield models_1.default.Cookbook.findAll({ include: "User" });
    ...
    if (token) {
        ...
        const userAuthData = yield cookbooks.map((cookbook) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({}, cookbook.dataValues), { likesCounter: likesCounter, isLike: isLike, isSaved: isSaved, commentCounter: commentCounter });
        }));
    ...
    return Promise.all(yield cookbooks.map((cookbook) => __awaiter(void 0, void 0, void 0, function* () {
        const likesCounter = yield cookbook.countCookbookUserLike();
        const commentCounter = yield cookbook.countCookbookComments();
        return Object.assign(Object.assign({}, cookbook.dataValues), { isSaved: false, isLike: false, likesCounter: likesCounter, commentCounter: commentCounter });
    }))).then((values) => values);
});
