...
const getUserRecepies = (id, req) => __awaiter(void 0, void 0, void 0, function* () {
    const recepies = yield models_1.default.User.findOne({
        where: { id: id },
    }).then((user) => user.getUserRecepieSave());
    ...
    if (token) {
        ...
        const userAuthData = yield recepies.map((recepie) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const userData = yield models_1.default.User.findByPk(recepie.UserId);
            return Object.assign(Object.assign({}, recepie.dataValues), { User: userData, likesCounter: likesCounter, isLike: isLike, isSaved: isSavedRecepie, commentCounter: commentCounter });
        }));
    ...
    return Promise.all(yield recepies.map((recepie) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const commentCounter = yield recepie.countRecepieComments();
        const userData = yield models_1.default.User.findByPk(recepie.UserId);
        return Object.assign(Object.assign({}, recepie.dataValues), { User: userData, isSaved: false, isLike: false, likesCounter: likesCounter, commentCounter: commentCounter });
    }))).then((values) => values);
});
exports.default = getUserRecepies;
