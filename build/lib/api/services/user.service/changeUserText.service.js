...
const changeUserText = (newUserText, id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield models_1.default.User.findOne({ where: { id: id } }).then((user) => user.update({ userText: newUserText }));
});
