...
const addComment = [
    ...
    (0, express_validator_1.body)("recepieId").notEmpty().isString(),
...
const create = [
    ...
    (0, express_validator_1.body)("ingredients").notEmpty().isString(),
    (0, express_validator_1.body)("directions").notEmpty().isString(),
    (0, express_validator_1.body)("description").notEmpty().isString(),
    (0, express_validator_1.body)("cookingTime").notEmpty().isString(),
...
exports.recepie = { addComment, addToSave, create, deleteById, get, like };
