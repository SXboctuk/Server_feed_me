...
const addComment = [
    ...
    body("cookbookId").notEmpty().isString(),
    checkError(),
];
...
const create = [
    ...
    body("isVegatarian").notEmpty().isBoolean(),
    body("isWithoutEggs").notEmpty().isString(),
    body("isWithoutMilk").notEmpty().isString(),
    body("recepieIdList").notEmpty().isString(),
